...
CREATE TABLE `DatosSesion` (
  `idDatosSesion` int(11) NOT NULL AUTO_INCREMENT,
  `DatosSesioncol` varchar(45) DEFAULT NULL,
  `dato` int(11) NOT NULL,
  `idSesion` int(11) NOT NULL,
  PRIMARY KEY (`idDatosSesion`),
  KEY `idSesion_idx` (`idSesion`),
  CONSTRAINT `idSesion` FOREIGN KEY (`idSesion`) REFERENCES `Sesion` (`idSesion`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-04-02 19:26:58
