...
var ProductCtrl = /** @class */ (function () {
    ...
    ProductCtrl.prototype.saveProduct = function (req, res, next) {
        var product = new Product_1.Product(Model_1.Model.generateId(), req.body.category_id, req.body.name, 
        //req.file.filename,
        req.body.photo, req.body.video, req.body.price, req.body.color, req.body.age);
    ...
    ProductCtrl.prototype.setProduct = function (req, res, next) {
        ...
        SqlSource_1.default.getProductDetails(productId)
            ...
            var product = new Product_1.Product(productId, req.body.category_id ? req.body.category_id : result.category_id, req.body.name ? req.body.name : result.name, 
            //req.file.filename ? req.file.filename : result.photo,
            req.body.photo ? req.body.photo : result.photo, req.body.video ? req.body.video : result.video, req.body.price ? req.body.price : result.price, req.body.color ? req.body.color : result.color, req.body.age ? req.body.age : result.age);
